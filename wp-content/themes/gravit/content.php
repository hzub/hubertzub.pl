...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<?php the_content( __( 'Czytaj dalej <span class="meta-nav"><i class="fa fa-chevron-circle-right"></i></span>', 'gravit' ) ); ?>
		<?php wp_link_pages( array(
				'before' => '<div class="page-links"><div class="intro">Stron:</div>',
				'after'  => '</div>',
